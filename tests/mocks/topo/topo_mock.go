...
func (m *MockisFilter_Filter) MarshalTo(arg0 []byte) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockisFilter_FilterMockRecorder) MarshalTo(arg0 interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarshalTo", reflect.TypeOf((*MockisFilter_Filter)(nil).MarshalTo), arg0)
}

// Size mocks base method.
func (m *MockisFilter_Filter) Size() int {
	m.ctrl.T.Helper()
...
func (mr *MockisFilter_FilterMockRecorder) Size() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Size", reflect.TypeOf((*MockisFilter_Filter)(nil).Size))
}

// isFilter_Filter mocks base method.
func (m *MockisFilter_Filter) isFilter_Filter() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "isFilter_Filter")
}

// isFilter_Filter indicates an expected call of isFilter_Filter.
func (mr *MockisFilter_FilterMockRecorder) isFilter_Filter() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "isFilter_Filter", reflect.TypeOf((*MockisFilter_Filter)(nil).isFilter_Filter))
}
